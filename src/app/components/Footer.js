  ...
  return (
    <footer className="bg-slate-800 text-white py-8 text-center">
      <form onSubmit={handleSearch} className="mb-4">
        ...
        />
        <button type="submit" className="px-4 py-2 bg-blue-500 text-white rounded-md cursor-pointer hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
          Search
        </button>
      </form>
