    ...
    questions: [
      {
        ...
        answers: [
          { id: 1, text: "A block-based programming language", correct: true },
          { id: 2, text: "A text-based programming language", correct: false },
          { id: 3, text: "A drawing software", correct: false },
          { id: 4, text: "A web browser", correct: false },
        ],
      },
      {
        id: 2,
        ...
        answers: [
          { id: 1, text: "Stage", correct: true },
          { id: 2, text: "Sprites Pane", correct: false },
          { id: 3, text: "Blocks Palette", correct: false },
          { id: 4, text: "Scripts Area", correct: false },
        ],
      },
      {
        id: 3,
        ...
        answers: [
          { id: 1, text: "Use the 'move 10 steps' block", correct: true },
          {
            id: 2,
            text: "Use the 'play sound until done' block",
            correct: false,
          },
          { id: 3, text: "Click on the sprite", correct: false },
          { id: 4, text: "Use the 'switch backdrop to' block", correct: false },
        ],
      },
      {
        id: 4,
        ...
        answers: [
          { id: 1, text: "when green flag clicked", correct: true },
          { id: 2, text: "repeat 10", correct: false },
          { id: 3, text: "switch backdrop to", correct: false },
          { id: 4, text: "play sound until done", correct: false },
        ],
      },
      {
        id: 5,
        ...
        answers: [
          ...
          { id: 2, text: "Click on the Stage", correct: false },
          { id: 3, text: "Change the backdrop", correct: false },
          { id: 4, text: "Use the 'move 10 steps' block", correct: false },
        ],
      },
    ],
  }}
